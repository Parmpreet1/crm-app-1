...
const Layout: React.FC<LayoutProps> = ({ children, sidebar }) => {
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-gray-100 dark:bg-gray-900">
      <aside className="w-full md:max-w-[350px] px-4 py-6 flex flex-col gap-6 md:min-h-screen border-b md:border-b-0 border-gray-200 dark:border-gray-800 dark:bg-gray-900">
        {sidebar}
      </aside>
